...
#### Comment de Virginie : Pour ton dernier paragraphe, c'est pas une ANCOVA qu'on devrait faire à la place d'une ANOVA? Vu qu'on a plusieurs variables qui ont le potentiel d'influencer la variable réponse ? En plus, une ANCOVA c'est un mix ANOVA et régression donc c'est parfait vu qu'on a des variables qualitatives et quantitatives comme variables explicatives.


### Si jamais, les mères avec de l'hypertension ont de forte probabilité d'avoir des enfants prématurés et donc tout légers. Donc on a aussi des sales résultats (http://americanpregnancy.org/pregnancy-complications/pregnancy-induced-hypertension/)
