...
plot(stroke.surv, xlab="Months after diagnosis", ylab="Proportion of survivors", main="Survival over time")
```
...
```{r visu_sex, echo=F}
plot(stroke.surv.bysex, xlab="Months after diagnosis", ylab="Proportion of survivors", main="Survival over time by sex", col=c("green", "blue"))
